...
void TST_mod_parser::complete_parser_tests()
{
	...
	std::cout << "===============================================================" << std::endl;
	std::cout << " grammar with breakable and chain rules -- normal head " << std::endl;
	std::cout << "---------------------------------------------------------------" << std::endl;
	std::cout << " terminals: c, d, e" << std::endl;
	std::cout << " nonterminals: A, B, C, D" << std::endl;
	std::cout << " head: A" << std::endl;
	std::cout << " rules: " << std::endl;
	std::cout << " \tA-> B C C" << std::endl;
	std::cout << " \tC-> B B D" << std::endl;
