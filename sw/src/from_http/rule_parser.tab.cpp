...
#define YYSTYPE         RULE_STYPE
/* Substitute the variable and function names.  */
#define yyparse         rule_parse
#define yylex           rule_lex
#define yyerror         rule_error
#define yydebug         rule_debug
#define yynerrs         rule_nerrs
#define yylval          rule_lval
#define yychar          rule_char

/* First part of user prologue.  */
#line 2 "rule_parser.y"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NTERM = 3,                      /* NTERM  */
  YYSYMBOL_TERM = 4,                       /* TERM  */
  YYSYMBOL_SEP = 5,                        /* SEP  */
  YYSYMBOL_OR = 6,                         /* OR  */
  YYSYMBOL_LB = 7,                         /* LB  */
  YYSYMBOL_TOKEN_ERROR = 8,                /* TOKEN_ERROR  */
  YYSYMBOL_YYACCEPT = 9,                   /* $accept  */
  YYSYMBOL_rules = 10,                     /* rules  */
  YYSYMBOL_rule = 11,                      /* rule  */
  YYSYMBOL_alts = 12,                      /* alts  */
  YYSYMBOL_symbols = 13,                   /* symbols  */
...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined RULE_STYPE_IS_TRIVIAL && RULE_STYPE_IS_TRIVIAL)))
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NTERM", "TERM", "SEP",
  "OR", "LB", "TOKEN_ERROR", "$accept", "rules", "rule", "alts", "symbols",
  "symbol", YY_NULLPTR
};
...
{
       5,    14,     7,     8,     1,    15,    14,     6,     4,     0,
      13,    12
};

static const yytype_int8 yycheck[] =
{
       0,    10,     3,     4,     3,    13,    15,     7,     5,    -1,
       6,     6
};
...
#define yyclearin       (yychar = RULE_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use RULE_error or RULE_UNDEF. */
#define YYERRCODE RULE_UNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = RULE_EMPTY; /* Cause a token to be read.  */
...
yyerrlab:
  ...
  yytoken = yychar == RULE_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
