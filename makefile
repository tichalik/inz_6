...
build/obj/sw_rules.o: src/rules.cpp src/rules.h src/utils.h src/symbol.h
...
build/obj/sw_sppf.o: src/sppf.cpp src/sppf.h src/rules.h src/utils.h src/symbol.h
...
build/obj/sw_utils.o: src/utils.cpp src/utils.h
...
build/obj/tst_compares.o: tests/compares.cpp tests/compares.h tests/to_string.h \
 ...
 src/parser/mod_parser.h src/sppf.h src/vnode.h src/from_http/token.h
...
build/obj/tst_to_string.o: tests/to_string.cpp tests/to_string.h src/non_terminals.h \
 ...
 src/sppf.h src/vnode.h src/from_http/token.h
...
build/obj/tst_tst_html_response.o: tests/tst_html_response.cpp \
 ...
 src/non_terminals.h src/head.h src/rules.h src/sppf.h tests/compares.h \
 tests/to_string.h src/parser/mod_parser.h src/vnode.h \
 src/from_http/token.h src/to_http/html_response.h src/utils.h
...
build/obj/tst_tst_http_to_errors.o: tests/http_to_errors/tst_http_to_errors.cpp \
 ...
 src/to_http/html_response.h src/utils.h src/vnode.h src/sppf.h
...
build/obj/tst_tst_iterate_sppf.o: tests/to_http/tst_iterate_sppf.cpp \
 ...
 tests/to_string.h src/parser/mod_parser.h src/from_http/token.h
...
build/obj/tst_main.o: src/main.cpp src/server.h src/httplib.h src/to_http/mod_to_http.h \
 ...
 src/from_http/token.h src/check_errors/mod_check_errors.h \
 src/parser/mod_parser.h src/visualize_grammar/mod_visualize_grammar.h
	g++ src/main.cpp -o build/obj/tst_main.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 
...
build/obj/tst_model.o: src/model.cpp src/model.h src/from_http/mod_from_http.h \
 ...
 src/check_errors/mod_check_errors.h src/parser/mod_parser.h src/sppf.h \
 src/visualize_grammar/mod_visualize_grammar.h src/vnode.h
	g++ src/model.cpp -o build/obj/tst_model.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_rules.o: src/rules.cpp src/rules.h src/utils.h src/symbol.h
	g++ src/rules.cpp -o build/obj/tst_rules.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 
...
build/obj/tst_server.o: src/server.cpp src/server.h src/httplib.h \
 ...
 src/from_http/token.h src/check_errors/mod_check_errors.h \
 src/parser/mod_parser.h src/visualize_grammar/mod_visualize_grammar.h
	g++ src/server.cpp -o build/obj/tst_server.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_sppf.o: src/sppf.cpp src/sppf.h src/rules.h src/utils.h src/symbol.h
	g++ src/sppf.cpp -o build/obj/tst_sppf.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_utils.o: src/utils.cpp src/utils.h
	g++ src/utils.cpp -o build/obj/tst_utils.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_mod_check_errors.o: src/check_errors/mod_check_errors.cpp \
 src/check_errors/mod_check_errors.h src/grammar.h src/utils.h \
 src/symbol.h src/non_terminals.h src/head.h src/rules.h src/word.h \
 src/error.h
	g++ src/check_errors/mod_check_errors.cpp -o build/obj/tst_mod_check_errors.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_mod_from_http.o: src/from_http/mod_from_http.cpp \
 src/from_http/mod_from_http.h src/grammar.h src/utils.h src/symbol.h \
 src/non_terminals.h src/head.h src/rules.h src/word.h src/error.h \
 src/from_http/token.h
	g++ src/from_http/mod_from_http.cpp -o build/obj/tst_mod_from_http.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_tokenizer.o: src/from_http/tokenizer.cpp src/from_http/mod_from_http.h \
 src/grammar.h src/utils.h src/symbol.h src/non_terminals.h src/head.h \
 src/rules.h src/word.h src/error.h src/from_http/token.h
	g++ src/from_http/tokenizer.cpp -o build/obj/tst_tokenizer.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_mod_parser.o: src/parser/mod_parser.cpp src/parser/mod_parser.h \
 src/grammar.h src/utils.h src/symbol.h src/non_terminals.h src/head.h \
 src/rules.h src/error.h src/word.h src/sppf.h
	g++ src/parser/mod_parser.cpp -o build/obj/tst_mod_parser.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_html_response.o: src/to_http/html_response.cpp \
 src/to_http/html_response.h src/utils.h
	g++ src/to_http/html_response.cpp -o build/obj/tst_html_response.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_mod_to_http.o: src/to_http/mod_to_http.cpp src/to_http/mod_to_http.h \
 src/error.h src/to_http/html_response.h src/utils.h src/vnode.h \
 src/symbol.h src/sppf.h src/rules.h src/utils.h
	g++ src/to_http/mod_to_http.cpp -o build/obj/tst_mod_to_http.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 

build/obj/tst_mod_visualize_grammar.o: src/visualize_grammar/mod_visualize_grammar.cpp \
 src/visualize_grammar/mod_visualize_grammar.h src/vnode.h src/symbol.h \
 src/grammar.h src/utils.h src/non_terminals.h src/head.h src/rules.h
	g++ src/visualize_grammar/mod_visualize_grammar.cpp -o build/obj/tst_mod_visualize_grammar.o  -I src -I src/check_errors -I src/from_http -I src/parser -I src/to_http -I src/visualize_grammar  -c -fno-access-control $(FLAGS) 
